      ...
      <div className="form-group">
          ...
          <fieldset className="fieldset-btn-group">
            <legend>Velg beløp</legend>
              ...
              <div>
                  <input onChange={props.handleChange} type="radio" id="500" name="beløp" value={props.beløp}/>
                  <label  className="checkBtn" htmlFor="500">500</label>
              </div>
              <div>
                  <input onChange={props.handleChange} type="radio" id="750" name="beløp" value={props.beløp}/>
                  <label className="checkBtn" htmlFor="750">750</label>
              </div>
              <div>
                  <input onChange={props.handleChange} type="radio" id="1000" name="beløp" value={props.beløp}/>
                  <label className="checkBtn" htmlFor="1000">1000</label>
              </div>
          <div>
          <label htmlFor="custom">custom</label>
          <input id="custom" name="beløp" type="number"
            value={props.beløp}
